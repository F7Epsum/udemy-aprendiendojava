...
public class CinePlayer implements MediaDownloader.DownloadListener {

    private Movie toyStory = new Movie("Toy Story","Family",90);

    public void initialize(){

        toyStory.setWonOscar(true);
        MediaDownloader.download(toyStory.getTitle(), this);
